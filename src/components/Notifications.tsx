            ...
            <AnimatePresence>
                {isOpen && (
                    <motion.div
                        ...
                        className="absolute right-0 sm:right-0 -mr-2 sm:mr-0 mt-3 w-[calc(100vw-2rem)] sm:w-80 max-w-sm bg-black/95 backdrop-blur-2xl border border-white/10 rounded-2xl shadow-2xl z-[70] overflow-hidden"
                    >
