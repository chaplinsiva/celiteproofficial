        ...
        <div className="min-h-screen bg-white text-slate-800 pt-32 pb-20">
            <div className="container mx-auto px-4 max-w-4xl">
                ...
                >
                    ...
                    <h1 className="text-4xl md:text-5xl font-bold mb-4 text-slate-900">Terms & Conditions</h1>
                ...
                <div className="space-y-12 text-slate-650 leading-relaxed">
                    <section>
                        <h2 className="text-2xl font-bold text-slate-900 mb-4 flex items-center gap-3">
                            <CheckCircle className="w-6 h-6 text-indigo-600" /> 1. Acceptance of Terms
                        </h2>
                        <p>
                    ...
                    <section>
                        <h2 className="text-2xl font-bold text-slate-900 mb-4 flex items-center gap-3">
                            <AlertCircle className="w-6 h-6 text-indigo-600" /> 2. Use License
                        </h2>
                        <p className="mb-4">
                            ...
                            commercial projects, subject to the following terms:
                        </p>
                    ...
                    <section>
                        <h2 className="text-2xl font-bold text-slate-900 mb-4 flex items-center gap-3">
                            <HelpCircle className="w-6 h-6 text-indigo-600" /> 3. Payments and Refunds
                        </h2>
                        <p>
