...
const PrivacyPage = () => {
    return (
        <div className="min-h-screen bg-white text-slate-800 pt-32 pb-20">
            <div className="container mx-auto px-4 max-w-4xl">
                ...
                >
                    ...
                    <h1 className="text-4xl md:text-5xl font-bold mb-4 text-slate-900">Privacy Policy</h1>
                    <p className="text-slate-550">Last updated: January 31, 2026</p>
                </motion.div>

                <div className="space-y-12 text-slate-650 leading-relaxed">
                    <section>
                        <h2 className="text-2xl font-bold text-slate-900 mb-4 flex items-center gap-3">
                            <Eye className="w-6 h-6 text-indigo-600" /> 1. Information We Collect
                        </h2>
                        <p className="mb-4">
                        ...
                        <ul className="list-disc pl-6 space-y-2">
                            ...
                            <li>Usage Data: Information about how you use our wedding invitation video maker and templates.</li>
                    ...
                    <section>
                        <h2 className="text-2xl font-bold text-slate-900 mb-4 flex items-center gap-3">
                            <Lock className="w-6 h-6 text-indigo-600" /> 2. How We Protect Your Data
                        </h2>
                        <p>
                    ...
                    <section>
                        <h2 className="text-2xl font-bold text-slate-900 mb-4 flex items-center gap-3">
                            <FileText className="w-6 h-6 text-indigo-600" /> 3. Data Usage
                        </h2>
                        <p>
                    ...
                    <div className="p-8 bg-slate-50 border border-slate-200 rounded-2xl mt-16">
                        <p className="text-sm text-slate-550">
                            If you have any questions about our Privacy Policy, please contact us at
                            <span className="text-indigo-650 ml-1 font-bold">support@celitepro.com</span>.
                        </p>
                    </div>
                </div>
            </div>
