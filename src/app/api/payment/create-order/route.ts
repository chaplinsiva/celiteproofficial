...
export async function POST(request: NextRequest) {
    ...
    try {
        ...
        const { templateId, userId, projectId, singlePay } = body;
        ...
        // Dynamic single pay fetching or template default price
        const singlePayAmount = await getSinglePayAmount();
        const amount = singlePay ? singlePayAmount : (template.price || 9);
