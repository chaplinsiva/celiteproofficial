...
export async function GET(request: NextRequest) {
    // Protect this endpoint - only allow calls with valid CRON_SECRET
    ...
    try {
        ...
        // 1. Only protect users with an active, non-expired subscription
        // Expired subscribers are treated as free users — their data gets cleaned up
