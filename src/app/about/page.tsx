...
const AboutPage = () => {
    return (
        <div className="min-h-screen bg-[#070708] text-white pt-32 pb-20 relative selection:bg-indigo-500/30">
            <StarBackground />

            {/* Hero Section */}
            <section className="container mx-auto px-4 relative mb-40 lg:mb-60">
                <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full h-[600px] bg-indigo-600/20 blur-[150px] rounded-full -z-10" />
                ...
                >
                    <motion.span
                        ...
                        className="inline-block px-4 py-1.5 rounded-full bg-indigo-500/10 border border-indigo-500/20 text-indigo-400 text-xs font-bold uppercase tracking-widest mb-8"
                    >
                        Our Eternity Story
                    </motion.span>
                ...
                <div className="max-w-6xl mx-auto">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-24 items-start">
                        ...
                        <div className="space-y-32 relative">
                            ...
                            <div className="absolute left-6 top-8 bottom-8 w-[2px] bg-gradient-to-b from-indigo-500 to-transparent lg:left-1/2 lg:-translate-x-1/2 opacity-20" />
                            ...
                            {[
                                ...
                                >
                                    <div className="w-12 h-12 rounded-full bg-black border border-white/10 flex items-center justify-center relative z-10 shrink-0 lg:absolute lg:left-1/2 lg:-translate-x-1/2 group-hover:border-indigo-500 transition-colors">
                                        <item.icon className="w-5 h-5 text-indigo-400" />
                                    </div>
                                    <div className={`pl-12 lg:pl-0 lg:w-[45%] ${i % 2 === 0 ? 'lg:text-right' : 'lg:text-left'}`}>
                                        <span className={`text-5xl font-black text-white/5 group-hover:text-white/10 transition-colors`}>{item.year}</span>
                                        <h3 className="text-2xl font-bold text-white mb-4">{item.title}</h3>
                                        <p className="text-gray-500 leading-relaxed text-sm lg:text-base">{item.text}</p>
                                    </div>
                        ...
                        <div className="sticky top-40 hidden lg:block">
                            <motion.div
                                ...
                                className="relative aspect-[4/5] rounded-[2.5rem] overflow-hidden border border-white/10 p-2 bg-white/5 backdrop-blur-3xl"
                            >
                                <div className="absolute inset-0 bg-gradient-to-br from-indigo-600/10 via-transparent to-transparent" />
                                <img
                                    src="/logo.png"
                                    className="w-full h-full object-contain opacity-40 group-hover:scale-110 transition-transform duration-[2s]"
                                    alt="CelitePro Cinematic"
                                />
                                <div className="absolute bottom-8 left-8 right-8 p-8 rounded-3xl bg-black/40 backdrop-blur-xl border border-white/5">
            ...
            <section className="container mx-auto px-4 mb-60 relative">
                <div className="text-center mb-24">
                    ...
                    <p className="text-gray-500 max-w-xl mx-auto">The four pillars of CelitePro. Friends for life, founders for a reason.</p>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                    {team.map((member, index) => (
                        <motion.div
                            ...
                            viewport={{ once: true }}
                            className="group relative p-1 rounded-[2rem] bg-white/[0.03] border border-white/10 hover:border-white/20 transition-all hover:bg-white/[0.05] flex flex-col items-center text-center overflow-hidden"
                        >
                            ...
                            <div className="p-10 flex flex-col items-center">
                                ...
                                <p className="text-indigo-400 font-black text-[10px] uppercase tracking-[0.2em] mb-6">{member.role}</p>
                            ...
                            <span className="absolute bottom-[-20%] right-[-10%] text-[10rem] font-black text-white/[0.02] pointer-events-none group-hover:text-white/[0.04] transition-colors leading-none">
                                {index + 1}
                            </span>
                        </motion.div>
                    ))}
            ...
            <section className="container mx-auto px-4 pb-20">
                <motion.div
                    ...
                    className="relative rounded-[3.5rem] overflow-hidden bg-[#0A0A0B] border border-white/5 p-12 md:p-32 text-center group"
                >
                    <div className="absolute inset-0 bg-gradient-to-t from-indigo-600/10 via-purple-600/5 to-transparent pointer-events-none" />
                    ...
                    >
                        <h2 className="text-4xl md:text-7xl font-bold text-white mb-10 tracking-tight">
                            Our story never ends. <br />
                            <span className="text-indigo-400">It evolves with you.</span>
                        </h2>
                        ...
                        <div className="flex flex-wrap justify-center gap-12 opacity-40 grayscale group-hover:grayscale-0 group-hover:opacity-100 transition-all duration-700">
