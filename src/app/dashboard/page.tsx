            ...
            <header className="border-b border-white/5 bg-black/40 backdrop-blur-xl sticky top-0 z-50">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 py-3 sm:py-4 flex flex-wrap items-center justify-between gap-3">
                    ...
                    <div className="flex items-center gap-3 sm:gap-6 flex-wrap">
                        {isAdmin && (
                            <Link href="/admin" className="text-xs sm:text-sm font-bold text-indigo-400 hover:text-indigo-300 transition-all flex items-center gap-1.5 sm:gap-2 px-2.5 sm:px-3 py-1 sm:py-1.5 bg-indigo-500/10 border border-indigo-500/20 rounded-lg">
                        ...
                        <button
                            ...
                            className="flex items-center gap-1.5 sm:gap-2 text-xs sm:text-sm font-medium text-gray-400 hover:text-red-400 transition-colors"
                        >
                ...
                <div className="mb-12 flex flex-col md:flex-row md:items-center justify-between gap-8">
                    ...
                    {user && (
                        <div className="flex items-center gap-4 p-4 bg-white/[0.02] border border-white/5 rounded-2xl w-full md:w-auto">
                            <div className="w-10 h-10 md:w-12 md:h-12 bg-indigo-600/20 rounded-full flex items-center justify-center shrink-0 overflow-hidden">
                        ...
                        {subscription.hasSubscription && subscription.plan && subscription.subscription ? (
                            <div className="space-y-6">
                                ...
                                {(subscription.subscription.status !== "active" && subscription.subscription.status !== "trialing") && (
                                     <div className="mt-6 p-4 bg-red-500/10 border border-red-500/20 rounded-xl flex items-start gap-3">
                                         ...
                                         <div>
                                             <h4 className="text-sm font-bold text-red-400 mb-1">Storage Deletion Warning</h4>
                                             <p className="text-xs text-red-300">Your subscription has ended. To prevent your uploads, projects, and generated videos from being permanently deleted in 30 days, please renew your plan.</p>
                                         </div>
                                     </div>
                                )}
                                ...
                                <div className="grid md:grid-cols-2 gap-6 mt-6">
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        {subscription.warnings?.rendersExhausted && (
                                            <p className="text-xs text-red-400">Credit limit reached. Renews on {new Date(subscription.subscription.validUntil).toLocaleDateString()}</p>
                                        )}
                                    </div>
                            ...
                            <div className="space-y-6">
                                <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                                    <div className="flex items-center gap-4">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-sm text-gray-500">Projects & renders deleted after 7 days.</p>
                                        </div>
                                    </div>
                                    <Link
                                        href="/pricing"
                                ...
                                <div className="p-4 bg-amber-500/10 border border-amber-500/20 rounded-xl flex items-start gap-3">
                                    ...
                                    <div>
                                        <h4 className="text-sm font-bold text-amber-400 mb-1">Free Tier Limitations</h4>
                                        <p className="text-xs text-amber-300">All projects, media uploads, and free previews are unconditionally deleted 7 days after creation on the Free Plan. Upgrade to retain your files permanently.</p>
                                    </div>
                                </div>
                                ...
                                <div className="max-w-md space-y-2">
                                    <div className="flex items-center justify-between text-sm">
                                        ...
                                        <span className="text-white font-medium">
                                            {subscription.subscription?.storageUsedGb || "0.00"}GB / 500MB
                                        </span>
                                    </div>
                                    <div className="h-2 bg-white/5 rounded-full overflow-hidden">
                                        <div
                                                ...
                                                {job.status === "completed" && isCloudflareUrl(job.output_url) ? (
                                                    ...
                                                    <div className="w-full flex flex-row gap-2">
                                                        <button
                                                            ...
                                                            className="flex-1 py-2.5 bg-indigo-600/20 hover:bg-indigo-600/30 text-indigo-400 text-xs font-bold rounded-lg flex items-center justify-center gap-2 border border-indigo-500/20 disabled:opacity-50 transition-all"
                                                        >
