            ...
            >
                <div className="bg-black/40 backdrop-blur-2xl border border-white/10 rounded-3xl p-8 md:p-10 shadow-2xl relative overflow-hidden">
                    ...
                    <div className="flex flex-col items-center mb-10">
                        ...
                        <p className="text-gray-400 text-center mt-2">Start creating your perfect video today.</p>
                    </div>
                    ...
                    <p className="text-center text-gray-500 text-sm mt-8">
                        ...
                        <Link href={`/login${queryString}`} className="text-indigo-400 hover:text-indigo-300 font-medium transition-colors">
                            Log in
                        </Link>
                    </p>
                </div>
