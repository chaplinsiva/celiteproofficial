...
export default function SignUp() {
    ...
    return (
        <main className="min-h-screen bg-white flex items-center justify-center p-4 relative overflow-hidden">
            {/* Background Glow */}
            <div className="absolute top-1/4 left-1/4 w-96 h-96 bg-blue-50/50 blur-[120px] rounded-full pointer-events-none" />
            <div className="absolute bottom-1/4 right-1/4 w-96 h-96 bg-rose-50/40 blur-[120px] rounded-full pointer-events-none" />
            ...
            >
                <div className="bg-slate-50/70 border border-slate-200 shadow-xl backdrop-blur-2xl rounded-3xl p-8 md:p-10 relative overflow-hidden">
                    ...
                    <div className="flex items-center gap-4 mb-6">
                        ...
                        <span className="text-sm text-slate-500 font-medium">or sign up with email</span>
                        <div className="flex-1 h-px bg-slate-200"></div>
                    </div>
                    ...
                    <form onSubmit={handleSignUp} className="space-y-5">
                        ...
                        {error && (
                            <div className="bg-red-50 border border-red-100 text-red-655 text-sm p-4 rounded-xl">
                                {error}
                            </div>
                        )}

                        {message && (
                            <div className="bg-emerald-50 border border-emerald-100 text-emerald-600 text-sm p-4 rounded-xl">
                                {message}
                            </div>
                        )}
                    ...
                    <p className="text-center text-slate-500 text-sm mt-8">
                        ...
                        <Link href={`/login${queryString}`} className="text-indigo-600 hover:text-indigo-500 font-bold transition-colors">
                            Log in
                        </Link>
                    </p>
                </div>
