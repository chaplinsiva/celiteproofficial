...
export async function getTemplateSEO(slug: string): Promise<SEOData | null> {
    try {
        ...
        return {
            ...
            description: data.meta_description || data.description || `Create and edit your perfect video template. The best online video maker and editor. Customize ${data.title} today.`,
            keywords: data.keywords,
