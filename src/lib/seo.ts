...
export async function getTemplateSEO(slug: string): Promise<SEOData | null> {
    try {
        ...
        return {
            ...
            description: data.meta_description || data.description || `Create and edit your perfect wedding template. The best online wedding invitation video maker and save the date editor. Customize ${data.title} today.`,
            keywords: data.keywords,
